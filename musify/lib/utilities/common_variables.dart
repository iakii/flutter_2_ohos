...
const commonCustomBarRadiusFirst = BorderRadius.vertical(top: Radius.circular(18));
...
const commonBarContentPadding = EdgeInsets.symmetric(vertical: 12, horizontal: 8);
